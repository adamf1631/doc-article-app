...
import Header from "./headers/charitiesHeader";
import Article from "./article";

const CharitiesArticles = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			let results = await axios.get(
				"https://catholiccharitiescamden.org/wp-json/wp/v2/posts?_embed&categories=45"
			);
...
export default CharitiesArticles;
